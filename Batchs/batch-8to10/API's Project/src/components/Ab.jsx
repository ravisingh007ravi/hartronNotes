      ...
      <div className="relative">
        ...
        {Click && (
          <div className="fixed inset-0 flex justify-center items-center z-50">
            ...
            <div className="absolute inset-0 bg-white/10 backdrop-blur-lg backdrop-saturate-150"></div>

            {/* Modal content */}
            <div className="relative bg-red-600/90 rounded-xl shadow-2xl w-96 p-6 transform transition-all duration-300 scale-100 backdrop-blur-sm border border-white/20">
              ...
              <div className="flex flex-col items-center justify-center py-8">
                <div className="bg-white bg-opacity-20 rounded-full p-6 mb-4 backdrop-blur-sm">
              ...
              <div className="mt-4 flex justify-center">
                <button
                  onClick={() => setClick(false)}
                  className="bg-white/90 text-red-600 px-6 py-2 rounded-full font-semibold hover:bg-white transition-all duration-200 flex items-center gap-2 backdrop-blur-sm"
                >
                  <FaTimes />
                  Close Modal
                </button>
