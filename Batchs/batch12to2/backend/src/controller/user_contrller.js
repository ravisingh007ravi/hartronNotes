...
export const create_user = async (req, res) => {
    try {
        ...
        if (existingUser) {
            ...
            return res.status(200).send({ status: true, msg: 'Resend Otp Send Pls Verify Yourt Account...',
                data:{id: existingUser._id,fname:existingUser.fname,lname:existingUser.lname,email:existingUser.email}
             })
        }
